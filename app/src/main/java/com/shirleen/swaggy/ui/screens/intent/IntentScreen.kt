package com.shirleen.swaggy.ui.screens.intent
        ...
        content = { paddingValues ->
            ...
            Column(
                ...
                OutlinedButton(
                    ...
                    Text(text = "Pay with STK", color = newPurple)
                }
                ...
                OutlinedButton(
                    onClick = {
                        ...
                        smsIntent.data="smsto:0755301153".toUri()
                        smsIntent.putExtra("sms_body","Hello, how can I get my items?")
                        mContext.startActivity(smsIntent)
                    },
                    modifier = Modifier.width(200.dp).align(alignment = Alignment.CenterHorizontally),
                    shape = RoundedCornerShape(10.dp),
                ) {
                    Text(text = "Message us", color = newPurple)
                }
                ...
                OutlinedButton(
                    onClick = {
                        ...
                        callIntent.data="tel:0755301153".toUri()
                        mContext.startActivity(callIntent)
                    },
                    modifier = Modifier.width(200.dp).align(alignment = Alignment.CenterHorizontally),
                    shape = RoundedCornerShape(10.dp),
                ) {
                    Text(text = "Contact Now", color = newPurple)
                }
                ...
                OutlinedButton(
                    onClick = {
                        ...
                        shareIntent.putExtra(Intent.EXTRA_EMAIL, arrayOf("wanjikukabunyi0@gmail.com"))
                    ...
                    Text(text = "Send Email", color = newPurple)
                }
                ...
                OutlinedButton(
                    ...
                    Text(text = "Share App", color = newPurple)
                }
                ...
                OutlinedButton(
                    ...
                    Text(text = "Open Camera", color = newPurple)
                }
